...
export default class EditCapableTextBox extends React.Component{
  ...
  componentWillReceiveProps(nextProps){
    this.setState({
      inputValue : nextProps.content ? nextProps.content : this.props.editProjectDescriptionText ? defaultProjectDescriptionString : 'Please type some info'
    })
  }
  render(){
  ...
  renderElems(){
    ...
    let div = this.props.lock ? (<div className={this.props.divClass}>{this.state.inputValue}</div>) : (<div onClick={toggle} className={this.props.divClass +' pointer'}>{this.state.inputValue}</div>);
