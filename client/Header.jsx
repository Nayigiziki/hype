...
export default class Header extends React.Component{
  ...
  renderHeader(){
    let notLoggedIn = (<div id='innerHeaderDiv'>
                        ...
                        <ImgAndAClass edit={false} icon={null} text={'work'} destination='/work'/>
    ...
    let loggedIn = (<div id='innerHeaderDiv'>
                       <ImgAndAClass edit={true} editIcon={'plus'} icon={'shakLogo'} text={null} destination='/createProject'/>
                       <ImgAndAClass edit={true} editIcon={'pencil'} icon={'shakLogo'} text={null} destination='/editProjects'/>
                       <ImgAndAClass edit={false} icon={null} text={'work'} destination='/projects'/>
